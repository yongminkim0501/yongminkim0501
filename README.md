...
**백엔드 개발자 · 지금은 크래프톤 정글에서 CS를 파고드는 중**

</div>

> 동작하는 코드에서 멈추지 않고, **왜 그렇게 동작하는지**까지 파고드는 걸 좋아합니다.  
> 요즘은 서버가 어떻게 버티는가에 관심이 많습니다.

- 🔭 **진행 중** — 크래프톤 정글 SW-AI랩 13기
- 🌱 **관심사** — 백엔드 아키텍처, 성능 최적화, LLM 애플리케이션
- ⚡ **한 줄** — 삽질은 많이 하지만 같은 삽질은 두 번 안 하려고 기록합니다

## 🧑‍💻 기술 포폴 / 블로그
[www.todaytech.me](https://www.todaytech.me)
...
| 기간 | 소속 | 내용 |
|:---:|:---|:---|
| `2026.08 ~ 2027.01` | **크래프톤 정글** SW-AI랩 13기 | `진행 중` |
| `2020.03 ~ 2026.08` | **한양대학교 ERICA** 컴퓨터학부 | 학사 졸업 |
| `2025.07 ~ 2026.06` | **롯데이노베이트** 산학협력 캡스톤디자인 | 기업 현직자 멘토링 (학기 중 격주, 방학 중 주 1회 · 비대면) |

## 🏆 Awards

| 연도 | 수상 | 역할 |
|:---:|:---|:---:|
| `2026` | 🥉 **ERICA 소프트웨어융합대학 캡스톤디자인 경진대회 우수상 (3위)** <br/>AI 기반 업무 문서 요약 및 편집 시스템<sub> · 백엔드, 챗봇 에이전트, 인프라 개발, 기획, 일정 관리</sub> | 팀장 |
...
![Spring AI](https://img.shields.io/badge/Spring%20AI-347D39?style=for-the-badge&logo=spring&logoColor=white)
...
[![Blog](https://img.shields.io/badge/-MyBlog-20C997?style=flat-square&logo=MyBlog&logoColor=white)](https://www.todaytech.me/)
...
### 📊 GitHub Stats
![GitHub Stats](https://github-readme-stats-eight-theta.vercel.app/api?username=yongminkim0501&show_icons=true&theme=radical)
