...
| 기간 | 소속 | 내용 |
|:---:|:---|:---|
| `2026.08 ~ 2027.01` | **크래프톤 정글** SW-AI랩 13기 | CS 기초부터 AI까지, 몰입형 부트캠프 `진행 중` |
...
| 연도 | 수상 | 역할 |
|:---:|:---|:---:|
| `2026` | 🥉 **ERICA 소프트웨어융합대학 캡스톤디자인 경진대회 우수상 (3위)** <br/>AI 기반 업무 문서 요약 및 편집 시스템<sub> · 백엔드, 챗봇 에이전트, 인프라 개발</sub> | 팀장 |
